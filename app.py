...
def ocr_and_search(image, keyword):
    ...
    # Extract text using Tesseract for both English and Hindi OCR
    extracted_text = ""

    try:
        # Run OCR for English and Hindi
        ...
        st.warning(f"Error during OCR: {e}")
        extracted_text = extracted_text_english  # Fallback to English only
